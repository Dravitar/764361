...
We then created a box plot showing the price on the y axis, the city of departure on the x axis, and the city of distination as the color of the boxes (*Fig 10*). We can identify how some cities seem to have higher ranges in price. For instance, Delhi is the city with the lowest price and smallest range, regardless of whether it is a source or destination city. In *Fig 11*, instead, we can identify the role played by the different departure and arrival times of the flights. We created a box plot showing the price on the y axis, the departure time on the x axis, and the arrival time as the color of the boxes. Just like in the previous graph, we can identify differences in ranges, noting what combinations of arrival and departure time more common, and which have higher price ranges.
...
Further analysis of categorical variables provided additional insights. Box plots were used to examine the range of price values for each airline, the number of stops, the route, and the departure and arrival time. We were once again able to confirm the significant price difference between economy and business class tickets, with Vistara and Air India being the only airlines offering business class tickets. Moreover, the boxplots revealed that flights with one stop have a higher price range compared to flights with zero or more than two stops, although the latter have a larger number of outliers. *Fig 10* provided insights into the price ranges associated with different departure cities and destinations, with Delhi having the lowest prices and smallest range consistently. *Fig 11* demonstrated the influence of departure and arrival times on ticket prices, allowing us to identify common combinations and variations in price ranges associated with different time slots.
Overall, these additional analyses of categorical variables further enriched our understanding of the factors influencing flight prices. They provided valuable insights into the price variations among airlines, the impact of the number of stops, the influence of specific routes, and the role of departure and arrival times. Incorporating these insights into the model training and prediction process can help improve the accuracy and relevance of flight price predictions.
